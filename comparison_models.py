...
class reduced_dense_256_pool(Model):
    ...
    def __init__(self):
        ...
        self.model_name = "reduced_dense_256_pool"
        shape = (32, 32, 3)
        model = Sequential()
...
class reduced_dense_and_conv(Model):
    ...
    def __init__(self):
        ...
        self.model_name = "reduced_dense_and_conv"
        shape = (32, 32, 3)
        model = Sequential()
...
class reduced_dense_and_conv2(Model):
    ...
    def __init__(self):
        ...
        self.model_name = "reduced_dense_and_conv2"
        shape = (32, 32, 3)
        model = Sequential()
...
class reduced_dense_and_conv3(Model):
    ...
    def __init__(self):
        ...
        self.model_name = "reduced_dense_and_conv3"
        shape = (32, 32, 3)
        model = Sequential()
